...
- `design/verni-tactile-socle` — ✅ terminée et mergée sur `main` (2026-09-05),
  ...
  cinq tableaux de bord, les titres de fiche, les étiquettes en casse normale,
  les sections en rangées, la recherche dans les rapports. Aucune migration.
  **Vérification visuelle à la charge de l'utilisateur.** Voir `PLAN.md` § 8.
